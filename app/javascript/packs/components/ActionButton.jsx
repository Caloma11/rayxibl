      ...
      <p className="textBlue textLg bold">Add freelancers </p>
        ...
        />
          ...
          />
					...
					<a className="action-link flex items-center justify-content-between" href="/profiles">
          <img
            className=""
            src={search}
            alt="search"
          ...
          />
					...
					<a className="action-link flex items-center justify-content-between" href="/jobs/new">
           <img
            className=""
            src={brief}
            alt="brief"
          ...
          />
			...
			<button className="trigger" onClick={handleClick}>
				<img className="toggler" src={personAdd} alt="action button" width="32" height="32" />
			</button>
		</div>
	);
};
